            ...
            <div class="pcoded-inner-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        <!-- Start row -->
                        <h1 class="h3 mb-3"><strong>Account</strong></h1>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        $form->open_multipart("", "", "/add-account", "", "");
                                        $form->hidden("id", "id", "", "id", "", "", "", "");
                                        $form->email("email", "email", "", "email", "", "", "", "");
                                        $form->text("password", "password", "", "password", "", "", "", "");
                                        $form->text("fullname", "fullname", "", "fullname", "", "", "", "");
                                        $form->number("contact", "contact", "", "contact", "", "", "", "");
                                        $role = [
                                            'Administrator' => 'Administrator',
                                            'Employee' => 'Employee'
                                        ];
                                        $form->select("role", "role", "", "role", "", "", "", $role);

                                        $form->submit_button("Add New Account");
                                        $form->close();
                                        ?>
                                    </div>
                                </div>
