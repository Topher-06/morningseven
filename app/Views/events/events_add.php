                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Create New Events</h5>
                            </div>
                        ...
                        $form->open_multipart("","","/add-events","","");
								$form->hidden("e_id","e_id","","e_id","","","","");
								$form->file("e_image","e_image","","e_image","","","","");
								$form->date("e_date","e_date","","e_date","","","","");
								$form->text("e_title","e_title","","e_title","","","","");

                            $form->submit_button("Add New Events");
                        $form->close();
                            ?>
                            </div>
                        </div>
